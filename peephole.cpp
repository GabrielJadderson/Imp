...
static array* peephole_optimize_push_pop(array* code_array)
{
	...
	{
		char* instruction = (char*)array_at(code_array, i);
	...
	if (!did_fail)
	{
		...
		char* push_instruction_1 = (char*)array_at(window, 0);
		char* push_instruction_2 = (char*)array_at(window, 1);

		char* pop_instruction_1 = (char*)array_at(window, 2);
		char* pop_instruction_2 = (char*)array_at(window, 3);
...
{
	char* str_3 = (char*)Calloc(length + 1, 1);
...
char* substring_ins(char* array, size_t offset)
{
	...
	char* str_3 = (char*)Calloc(len - offset + 1, 1);
